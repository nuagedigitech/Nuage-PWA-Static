...
Webflow.define('maps', module.exports = function ($, _) {
  ...
  var googleMapsApiKey = 'AIzaSyBxKWJCw_wbdrE5yFse7LSCGPJAy41mM7E'; // -----------------------------------
  // Module methods
...
Webflow.require('ix').init([
  {"slug":"navbar","name":"Navbar","value":{"style":{},"triggers":[{"type":"scroll","selector":".img--logo","offsetTop":"0%","stepsA":[{"height":"60px","transition":"height 300ms ease 0"}],"stepsB":[{"height":"24px","transition":"height 300ms ease 0"}]}]}},
  {"slug":"text-field-interaction","name":"Text field interaction","value":{"style":{},"triggers":[{"type":"click","selector":".field-label","siblings":true,"preserve3d":true,"stepsA":[{"transition":"transform 300ms ease 0","scaleX":0.6180000000000004,"scaleY":0.6180000000000004,"scaleZ":1}],"stepsB":[]}]}},
  {"slug":"open-contact-modal","name":"Open contact modal","value":{"style":{},"triggers":[{"type":"click","selector":".contact--layer","stepsA":[{"display":"flex","opacity":1,"transition":"opacity 500ms ease 0"}],"stepsB":[]}]}},
  {"slug":"close-contact-modal","name":"Close contact modal","value":{"style":{},"triggers":[{"type":"click","selector":".contact--layer","stepsA":[{"opacity":0,"transition":"opacity 300ms ease 0"},{"display":"none"}],"stepsB":[]}]}}
]);
